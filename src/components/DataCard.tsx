...
function DataCard({ id, title, note, onRemove }) {
  return (
    <div className="w-screenh-full sm:w-1/2 md:w-1/3 p-4">
      <Card className="shadow-lg rounded-lg hover:shadow-2xl transition-shadow duration-300">
        ...
        <CardFooter className="p-4 bg-gray-100 rounded-b-lg " onClick={() => onRemove(id)}>
